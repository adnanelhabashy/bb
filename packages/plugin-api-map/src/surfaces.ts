...
export const SURFACE_GROUPS: SurfaceGroup[] = [
    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Resolve a workspace file through the message's canonical environment identity",
        ],
        apiSymbols: [
          "PluginMessageDirectiveRegistration",
          "PluginMessageDirectiveMessage.experimental_environmentId",
        ],
      ...
      },
      {
        ...
        bullets: [
          ...
          "Receive one canonical file reference and resolve it directly through the frontend file-resource API",
  ...
  },
  {
    ...
    surfaces: [
      ...
      {
        id: "file-resources",
        tagline: "Read or embed a file without learning its root",
        title: "Frontend file resources",
        summary:
          "Resolves a typed file identity into a short-lived same-origin URL for plugin app code. With this, a plugin can:",
        bullets: [
          "Fetch or embed workspace, host, and thread-storage files from a frontend slot",
          "Use the same canonical file reference for navigation, file openers, and resource URLs",
          "Load sibling HTML or Markdown assets through a confined, path-shaped base URL",
          "Resolve workspace and thread-storage locations on the core server",
          "Read, write, or list a canonical reference through the backend files SDK",
          "Test resolution deterministically through the frontend plugin harness",
        ],
        apiSymbols: [
          ...
          "FilesArea.experimental_resolveResource",
          "FileReadArgs.experimental_target",
          "FileWriteArgs.experimental_target",
          "FileListArgs.experimental_target",
          "PathListArgs.experimental_directory",
