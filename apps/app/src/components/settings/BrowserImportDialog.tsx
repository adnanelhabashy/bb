        ...
        {step.step === "fullDiskAccess" ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                Full Disk Access for Arc Agent in System Settings → Privacy &amp;
            ...
            {step.checked ? (
              <p className="text-xs text-destructive-text">
                ...
                reopening Arc Agent before the grant applies.
              </p>
            ) : null}
            <DialogFooter>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Which profile's cookies should be copied into the Arc Agent browser?
              </DialogDescription>
            </DialogHeader>
            <div
              role="radiogroup"
