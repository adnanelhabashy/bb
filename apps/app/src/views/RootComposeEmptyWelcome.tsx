...
import arcEmblemUrl from "../../../../assets/arc-emblem.png";
...
export function RootComposeEmptyWelcome({
  ...
  return (
    <div className="flex flex-col items-center gap-12 duration-500 animate-in fade-in-0 slide-in-from-bottom-2">
      <div className="flex select-none flex-col items-center gap-4" role="img" aria-label="Arc Agent">
        <img
          src={arcEmblemUrl}
          alt=""
          aria-hidden
        ...
        <div className="flex flex-col items-center gap-1.5">
          <span className="text-sm font-semibold uppercase tracking-[0.42em] text-foreground [margin-right:-0.42em]">
            Arc Agent
          </span>
          <span className="text-[11px] uppercase tracking-[0.28em] text-muted-foreground [margin-right:-0.28em]">
